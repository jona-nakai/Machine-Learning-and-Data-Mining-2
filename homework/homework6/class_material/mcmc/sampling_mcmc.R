...
y_samples_norm # this should be trivial
...
##########################
# PRACTICE MCMC: Metropolis-Hastings for a Bivariate Normal (Bayesian Metropolis)
##########################
library(mvtnorm)
...
# I've set up most of this; see if you can't complete the innards of the function
